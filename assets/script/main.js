...
const click = document.querySelector('a:nth-of-type(1)')
...
const doubleClick = document.querySelector('a:nth-of-type(2)')

doubleClick.addEventListener("dblclick", (e) => {
  doubleClick.classList.toggle("doubleClick");
});

const keydown = document.querySelector('a:nth-of-type(3)')
...
const longPress = document.querySelector('a:nth-of-type(4)')
...
const deviceMotion = document.querySelector('a:nth-of-type(5)')
